...
function News (){
    ...
    useEffect(()=>{
        const getData=async()=>{
            return await fetch(`http://localhost:3000/articles?_page=${name}&_limit=5`).then((res)=>
            res.json())
        }
        getData().then((res)=>{
            // console.log(res)
        ...
        const getData1=async()=>{
            return await fetch(`http://localhost:3000/articles?_page=${name}&_limit=20`).then((res)=>
            res.json())
        }
        getData1().then((res)=>{
            // console.log(res)
        ...
        const getData2=async()=>{
            return await fetch("http://localhost:3000/articles?_page=2&_limit=11").then((res)=>
            res.json())
        }
        getData2().then((res)=>{
            // console.log(res)
        ...
        // const getData=async()=>{
        //     return await fetch(`https://newsapi.org/v2/everything?q=${name}&page=4&pageSize=5&apiKey=17aa27bf10d34add8ee1ab6d5f101610`).then((res)=>
        //     res.json()).then((res)=>{
        //         return res.articles
        //     })
        // }
        ...
        // })
        // const getData1=async()=>{
        //     return await fetch(`https://newsapi.org/v2/everything?q=${name}&page=3&pageSize=20&apiKey=17aa27bf10d34add8ee1ab6d5f101610`).then((res)=>
        //     res.json()).then((res)=>{
        //         return res.articles
        //     })
        // }
