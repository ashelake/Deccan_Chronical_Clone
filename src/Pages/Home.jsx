...
function Home (){
    ...
    useEffect(()=>{
        const getData=async()=>{
                return await fetch("http://localhost:3000/articles?_page=1&_limit=5").then((res)=>
                res.json())
            }
            getData().then((res)=>{
                console.log(res)
...
const getData1=async()=>{
            return await fetch("http://localhost:3000/articles?_page=1&_limit=20").then((res)=>
            res.json())
        }
        getData1().then((res)=>{
            // console.log(res)
        ...
        //     return await fetch(`https://newsapi.org/v2/top-headlines?country=in&pageSize=5&apiKey=17aa27bf10d34add8ee1ab6d5f101610`).then((res)=>
        //     res.json()).then((res)=>{
        //         return res.articles
        //     })
        // }
